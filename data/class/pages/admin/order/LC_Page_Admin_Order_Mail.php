...
class LC_Page_Admin_Order_Mail extends LC_Page_Admin_Order_Ex
{
    ...
    public function init()
    {
        ...
        $this->arrDevice[DEVICE_TYPE_PC] = "PC";
        $this->arrDevice[DEVICE_TYPE_MOBILE] = "携帯";
        $this->arrDevice[DEVICE_TYPE_SMARTPHONE] = "スマートフォン";
    ...
    public function doSend(&$objFormParam)
    {
        ...
        if (count($arrErr) == 0) {
            ...
            foreach ($order_id_array as $order_id) {
                ...
                true,
                $objFormParam->getValue('device_id'));
            }
    ...
    public function lfInitParam(&$objFormParam)
    {
        ...
        $objFormParam->addParam('送信先端末',"device_id",INT_LEN, 'n', array("EXIST_CHECK","NUM_CHECK"));
    }
}
