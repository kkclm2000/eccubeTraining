...
class LC_Page_Contact extends LC_Page_Ex
{
    ...
    public function lfRegisterContactData(){
        $sqlval = array();
        $objQuery = new SC_Query();

        //データベース登録用の配列に値を代入
        $sqlval['name01'] = $this->arrForm['name01']['value'];
        $sqlval['name02'] = $this->arrForm['name02']['value'];
        $sqlval['email'] = $this->arrForm['email']['value'];
        $sqlval['zip01'] = $this->arrForm['zip01']['value'];
        $sqlval['zip02'] = $this->arrForm['zip02']['value'];
        $sqlval['pref'] = $this->arrForm['pref']['value'];
        $sqlval['addr01'] = $this->arrForm['addr01']['value'];
        $sqlval['addr02'] = $this->arrForm['addr02']['value'];
        $sqlval['tel01'] = $this->arrForm['tel01']['value'];
        $sqlval['tel02'] = $this->arrForm['tel02']['value'];
        $sqlval['tel03'] = $this->arrForm['tel03']['value'];
        $sqlval['contacts'] = $this->arrForm['contacts']['value'];
        $sqlval['create_date'] = $this->arrForm['create_date']['value'];
